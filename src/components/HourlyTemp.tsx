            ...
            <CardContent>
                <div className="h-[200px] w-full">
                    ...
                    <LineChart data={chartData}>
                                ...
                                if(active && payload && payload.length){
                                    return (
                                        <div className="bg-black p-2 rounded shadow-lg">
                                            ...
                                            <p className="text-sm text-white">Temperature: {payload[0].value}°C</p>
                                            <p className="text-sm text-gray-500">Feels like: {payload[1].value}°C</p>
                                        </div>
                                    )
                                }
                                return null;
                        ...
                        <Line type={"monotone"} dataKey={"feel_like"} stroke="#64748b" strokeDasharray="5 5" strokeWidth={2} dot={false}/>
                    </LineChart>
                    </ResponsiveContainer>
                </div>
